...
$(document).ready(function(){
	...
	$(".latest .button-group [data-toggle]").attr('data-placement','top');
	$(":lang(ar) .latest .button-group [data-toggle]").attr('data-placement','top');
	/**/
	...
	if ($(window).width() > 991) {
		...
		$('.hiden_vertical_menu').append('<span class="more-menu">More Categories</span>');	
