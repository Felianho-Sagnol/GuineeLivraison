<?php 
    ...
    $commands = $panier->getCommandsForRestaurant(intval($_SESSION["currentRestaurant"]['id']));
                                        ...
                                        ?> 
                                            <div class="row">
                                                ...
                                                <p>
                                                    ...
                                                    <span style='font-size: 12px; font-weight: bold;margin-right:4px;color:black'>Nombre de produits  :  </span><?=$_restaurent['name']; ?>. <br>
                                                    <span style='font-size: 12px; font-weight: bold;margin-right:4px;color:black'>Etat  :  </span><?=($command['state'] == 1)?"Livrée":"Non livrée"; ?>. <br>
                                                    <a style="margin-top:2px" class='btn btn-primary mt-2' href="commandes.php?commandeId=<?=$command['id']; ?>">
                                                        Voir la commande
                                                    </a>
                                                </p>
                                                <hr>
