                    ...
                    <div class="header-top">
                            <div class="container">
                                <div class="header-logo ">
                                    <div id="logo">
                                        <a href=""><h1 style="font-size:25px" class="logo-title"><?=$_SESSION['currentRestaurant']['name'];?></h1></a>
                                    </div>
                                </div>
                                ...
                                <div id="verticalmenublock" class="box category box-category ">
                                    ...
                                    <div class="box-content categorymenu_block dropdown-menu" aria-labelledby="verticalmenu-dropdown">
                                        <ul id="nav-one" class="dropmenu">
                                            <li class="top_level dropdown main"><a href="#">Plats</a>
                                                <div class="dropdown-menu megamenu column1">
                                                    <div class="dropdown-inner">
                                                        <ul class="list-unstyled childs_1">
                                                            <li><a href="viewAllPlats.php">Voir tous les plats</a></li>
                                                            <li><a href="createPlats.php">Ajouter un plat</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="top_level dropdown main"><a href="#">Parametres</a>
                                                <div class="dropdown-menu megamenu column1">
                                                    <div class="dropdown-inner">
                                                        <ul class="list-unstyled childs_1">
                                                            <li><a  href="modifierRestaurant.php">Changez les parametres.</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="top_level dropdown main"><a href="#">Commandes</a>
                                                <div class="dropdown-menu megamenu column1">
                                                    <div class="dropdown-inner">
                                                        <ul class="list-unstyled childs_1">
                                                            <li><a  href="allsCommands.php">voir les commandes.</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </li>
                                ...
                                <div class="nav-inner">
                                        ...
                                        <div id="menu" class="main-menu">
                                            <ul class="nav navbar-nav">
                                                ...
                                                <li class="top_level"><a href="../views/restaurantContent.php?id=<?=$_SESSION['currentRestaurant']['id'];?>">Voir le contenu de votre restaurant</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <!--  =============================================== Mobile menu start  =============================================  -->
                                    <div id="res-menu" class="main-menu nav-container1">
                                        ...
                                        <ul class="main-navigation">
                                            <li class="top_level dropdown"><a href="#">Plats</a>
                                                <ul>
                                                    <li><a href="viewAllPlats.php">Voir tous les plats</a></li>
                                                    <li><a href="createPlats.php">Ajouter un plat</a></li>
                                                </ul>
                                            </li>
                                            <li class="top_level dropdown"><a href="#">Parametrage</a>
                                                <ul>
                                                    <li><a  href="modifierRestaurant.php">Changez les parametres</a></li>
                                                </ul>
                                            </li>
