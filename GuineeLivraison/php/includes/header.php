                    ...
                    <div class="header-top">
                            <div class="container">
                                <div class="header-logo">
                                    <div id="logo">
                                        <a href=""><h1 class="logo-title">Guinée Livraison</h1></a>
                                    </div>
                                </div>
                                        ...
                                        <?php
                                            if(isset($_SESSION["user"])){
                                                ...
                                                if(isset($_SESSION["user"]["isAdmin"]) AND $_SESSION["user"]["isAdmin"] == 1){
                                                    ?>
                                                        <li><a href="../admin/index.php" title="">Administration</a></li>
                                                    <?php
                                                }
                                            }
                                        ?>
                                ...
                                <div id="search" class="input-group">
                                    ...
                                    <div class="search_toggle">
                                        <div id="searchbox">
                                            <input id='searchInput' type="text" name="search" value="" placeholder="Rechercher un produit sur Guinée Livraison" class="form-control input-lg" />
                                ...
                                <div class="nav-inner">
                                        ...
                                        <div id="menu" class="main-menu">
                                            <ul class="nav navbar-nav">
                                                ...
                                                <li class="top_level"><a href="../views/contact.php">Contact</a></li>
                                                <li class="top_level"> <a href="../views/blog.php">Blogs </a></li>
