                        ...
                        <div class="footerleft-block">
                            ...
                            <div class="col-sm-3 column">
                                ...
                                <?php
                                    ...
                                    <li><a href="../views/panier.php" title="Votre Panier">Mon Panier</a></li>
                                    <?php
                                            if(isset($_SESSION["user"])){
                                                ?>
                                                    <li><a href="../views/deconnexion.php">Deconnexion <span class="connectedfooter active">(connecté)</a></li>
                                                <?php
                                            }
                                    ?>
                                </ul>
        ...
        <div id="bottom-footer" class="bottomfooter">
            ...
            <div class="page-container container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p  class="text-center copyright"> © 2020-2021, Tous les droits sont reservés à Guinée Livraison</p>
                    </div>
                    <div class="col-md-3"></div>
                </div>
            </div>
